...
const FRadioGroup: React.FC<FRadioGroupProps> = function (props) {
    ...
    return (
        <div className={classnames(...containerClass)}>
            ...
            {type === 'radio' && children && React.Children.map<props>(children,({ props }) => <FRadio {...props} onChange={(value, { e }) => handleChange(e, value)} key={props.value} checked={value === props.value}>{props.children}</FRadio>)}
